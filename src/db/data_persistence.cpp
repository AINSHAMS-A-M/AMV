...
void save_data()
{
    ...
    csv_out.open(users_path, std::ios::out);
    ...
    // Write users data, backtick-delimited
	...
	// --- Save polls ---
	std::string polls_path = data_dir + "polls.csv";
    csv_out.open(polls_path, std::ios::out);
	...
	// --- Save pollOptions ---
	std::string pollOptions_path = data_dir + "pollOptions.csv";
    csv_out.open(pollOptions_path, std::ios::out);
    ...
    // Write poll options data, backtick-delimited
	...
	// --- Save UserVotes ---
	std::string userVotes_path = data_dir + "userVotes.csv";
    csv_out.open(userVotes_path, std::ios::out);
    ...
    // Write user votes data, backtick-delimited
