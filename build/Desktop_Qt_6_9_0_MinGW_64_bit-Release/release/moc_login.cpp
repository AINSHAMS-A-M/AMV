...
void LoginPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->registerLinkActivated((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (LoginPage::*)()>(_a, &LoginPage::loginClicked, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (LoginPage::*)(const QString & )>(_a, &LoginPage::registerLinkActivated, 1))
            return;
    }
}
...
// SIGNAL 1
void LoginPage::registerLinkActivated(const QString & _t1)
{
